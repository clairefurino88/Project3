                ...
                <Row>
                    ...
                    <Col size="md" span="6">
                        <div className="postUserAndTime">
                            ...
                            <div className="postTime" style={{ fontSize: "12px" }}>Shared: <span style={{ color: 'yellow', fontSize: '11px', textDecorationLine: 'underline' }}>{time}</span></div>
                        </div>
                    </Col>
                    {/* Post Category Column */}
                    <Col size="md" span="4">
                        <div className="text-right">  {UserId == user_id ? <button className="del-btn"><span>✗</span></button> : ""}</div>
